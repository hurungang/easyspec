...
Requires npm Trusted Publishing configured for this repo: add `hurungang/easyspec` as a trusted publisher with workflow path `.github/workflows/easyspec-npm-release.yml` (leave Environment blank). No tokens needed.
